...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	private void initPageView() {
		...
		llPage.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#80000000")));
		...
		resId = getBitmapRes(getContext(), "btn_canel_back");
		if(resId > 0){
			btnCancel.setBackgroundResource(resId);
		}else {
		    btnCancel.setBackgroundDrawable(new ColorDrawable(0x8f000000));
		}
